        ...
        <div class="col-md-4" style="margin-top: 5%;right: 8%; position:absolute; left:400px;">
            <div class="card" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="card-body">
                    <center>
                        <br>
                        <h3 style="margin-top: 10%; color:black;">Patient Login</h3><br>
                        <form class="form-group" method="POST" action="func.php">
                            <div class="row" style="margin-top: 10%">
                                <div class="col-md-4"><label>Email: </label></div>
                                <div class="col-md-8"><input type="text" name="email" class="form-control"
                                        placeholder="Email" required /></div><br><br>
                            ...
                            <div class="row">
                                <div class="col-md-4" style="padding-left: 160px;margin-top: 10%">
                                    <center><input type="submit" style="background-color:black;" id="inputbtn"
                                            name="patsub" value="Login" class="btn btn-dark"></center>
                                </div>
