...
<div class="col-md-4">
    <input type="submit" name="entry_submit" value="Create new entry" class="btn btn-dark" id="inputbtn">
</div>
    ...
    <div class="card">
        <div class="card-body">
            <form class="form-group" method="post" action="func.php">
                ...
                <hr>
                <input type="submit" value="update" name="update_data" class="btn btn-dark">
            </form>
        </div>
    </div><br><br>
</div>
